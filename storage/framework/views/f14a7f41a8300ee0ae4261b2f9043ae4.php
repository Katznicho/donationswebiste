            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex justify-between items-center"> <!-- Changed here -->
                    ...
                    <div class="flex space-x-4"> <!-- Changed here -->
                        <!-- Add Payment Button -->
                        <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Payment</a>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1242873616-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH /home/codeartisan/Desktop/laravelapps/dummy3/dummy2/resources/views/dashboard.blade.php ENDPATH**/ ?>