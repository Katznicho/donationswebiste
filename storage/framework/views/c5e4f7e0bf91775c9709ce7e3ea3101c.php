                    ...
                    <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex flex-col bg-white rounded-lg shadow-md py-2 px-4"
                            ...
                            <img class="w-full h-40 object-fit: cover rounded-md  mt-2"
                                src="<?php echo e($child->profile_picture); ?>" alt="<?php echo e($child->first_name); ?>">
                            <h3 class="text-lg font-medium  mt-5  text-blue-900" ><?php echo e($child->first_name); ?>
                                ...
                                <span class="close-button" onclick="Close()">&times;</span> 
                                    <div class="upper-section">
                                        <div class="details-section">
                                            <img src="<?php echo e($child->profile_picture); ?>"
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeartisan/Desktop/laravelapps/dummy2/resources/views/child/child.blade.php ENDPATH**/ ?>