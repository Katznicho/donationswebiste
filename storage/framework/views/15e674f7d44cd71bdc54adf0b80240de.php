<div class="bg-white-200 py-0 lg:py-30 px-0 mb-10 items-center justify-between tab-text" id="tab1Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        <div class="lg:w-1/2 lg:mr-4 order-2 lg:order-1 mt-10 lg:mt-0">
            ...
            <h1 class="title text-7xl font-bold text-black mb-4">Make a difference.</h1>
...
<?php /**PATH D:\Projects\Bethel Donations\dummy\New\dummy_new\dummy_new\resources\views/components/donate.blade.php ENDPATH**/ ?>