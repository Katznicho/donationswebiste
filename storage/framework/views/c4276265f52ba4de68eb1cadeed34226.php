    ...
    <div class="container mx-auto py-40 px-40">
        ...
        <div class="flex rounded-lg shadow-md mb-8 border border-blue-300 w-1/2 h-100 ">
            ...
            <div>
                ...
                <p class="text-blue-600 mt-0">Birthday: <?php echo e($formatted_dob); ?></p>
...
data?.data?.forEach(child => {
    if (child) {
        ...
        let formattedDob = dob.getDate() + nth(dob.getDate()) + ' ' + monthNames[dob.getMonth()] + ' ' + dob.getFullYear();
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codeartisan/Desktop/laravelapps/dummy3/dummy2/resources/views/contact.blade.php ENDPATH**/ ?>