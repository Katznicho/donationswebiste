        ...
        <table id="transactionTable"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   ...
                   <td class="px-6 py-4 whitespace-nowrap"><?php echo e($transaction->child->first_name ?? ''); ?> <?php echo e($transaction->child->second_name ?? ''); ?></td>
...
<?php $__env->stopPush(); ?><?php /**PATH /home4/fountainofpeaceo/dummy.fountainofpeace.org.ug/resources/views/livewire/transaction-table.blade.php ENDPATH**/ ?>