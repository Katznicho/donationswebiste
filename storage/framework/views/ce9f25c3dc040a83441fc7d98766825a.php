<div class="bg-white-200 py-4 px-6 mb-20 items-center justify-between tab-text " id="tab2Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="lg:w-1/2 mt-10 lg:mt-0 order-1 flex items-center justify-center h-1/2">
            ...
            <img src="<?php echo e(asset('images/banners/child.jpg')); ?>" alt="Banner Image"
...
<?php /**PATH D:\Projects\Bethel Donations\dummy2\New folder\dummy2 (2)\dummy2\resources\views/components/childtab.blade.php ENDPATH**/ ?>