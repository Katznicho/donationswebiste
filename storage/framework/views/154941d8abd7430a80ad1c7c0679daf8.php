                ...
                <?php else: ?>
                    <?php $__currentLoopData = $mothers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex flex-col bg-white rounded-lg shadow-md py-2 px-2" id="<?php echo e($child->id); ?>">
                            ...
                            <h3 class="font-bold mt-5 text-blue-900 w-full text-lg text-left"><?php echo e($child->first_name); ?>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Bethel Donations\dummy2\New folder\dummy2 (2)\dummy2\resources\views/mother/mother.blade.php ENDPATH**/ ?>