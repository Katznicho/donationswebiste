    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4 md:space-x-6">
            ...
            <div id="mobile-menu" class="md:flex sm:hidden md:hidden lg:hidden hidden items-center space-x-4">
                <a href="<?php echo e(route('home')); ?>" class="hover:underline">About</a>
                <a href="<?php echo e(route('login')); ?>" class="hover:underline"><i class ="fa fa-phone" ></i>+2349067322844</a>
...
<?php /**PATH D:\Projects\Bethel Donations\dummy\New\dummy_new\dummy_new\resources\views/partials/donateheader.blade.php ENDPATH**/ ?>