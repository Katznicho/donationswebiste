...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mx-auto py-40 px-20">
        <!-- Card with individual information -->
        <div class="summary flex rounded-lg shadow-md mb-8 border border-blue-300  h-100 ">
            <img class="w-20 h-20 rounded-full object-cover mr-10 mt-5 mb-0 ml-10" src="<?php echo e($child->profile_picture); ?>"
            ...
            <div>
                <h3 class=" font-bold mb-0 text-xl mt-5 text-blue-900"><?php echo e($child->first_name); ?>

                    <?php echo e($child->second_name); ?> <span class= "ageup"><?php echo e($age); ?> yrs</span></h3>
                ...
                <div class="flex items-center justify-start text-black-600 mt-5 mb-5">
                    <!-- Checkbox -->
                    <input type="radio" id="monthlySubscription" class="mr-3" name="subscriptionType">
                    <label for="monthlySubscription" class="text-black-600 mr-2 md:mr-5"> $35/mth</label>

                    <!-- Radio Button -->
                    <input type="radio" id="annualSubscription" name="subscriptionType" class="mr-3">
                    <label for="annualSubscription" class="text-black-600 inline-flex flex md:mx-auto"> $420/yr</label>
                </div>
                        ...
                        .then(data => {
                            ...
                            data?.data?.forEach(child => {
                                if (child) {
                                    ...
                                    let childHtml = `
            <div class="flex rounded-lg shadow-md mb-8 border border-blue-300 w-1/2 h-100">
                <img class="w-20 h-20 rounded-full object-cover mr-10 mt-5 mb-0 ml-10" src="${child.profile_picture}" alt="Placeholder Image">
                <div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Bethel Donations\dummy\dummy2\resources\views/contact.blade.php ENDPATH**/ ?>