<div class="bg-white-200 py-4 px-6 flex mb-20 items-center justify-between tab-text " id="tab3Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        <div class="flex-1 mr-4 ">
            ...
            <!-- Sponsor Button -->
             <div class="mt-10">
                          <a class="bg-blue-900 text-white px-4 py-2 rounded-md my-5 " href="<?php echo e(route('contact')); ?>">Sponsor</a>
             </div>
        </div>
        <div class="flex-1 flex">
            <!-- Image with object-cover to cover the same height as text -->
            <img src="<?php echo e(asset('images/banners/child.jpg')); ?>" alt="Banner Image" class="h-1/4 w-full object-cover">
        </div>

    </div>
</div>
<?php /**PATH D:\Projects\Bethel Donations\dummy2\New folder\dummy2 (2)\dummy2\resources\views/components/mothertab.blade.php ENDPATH**/ ?>