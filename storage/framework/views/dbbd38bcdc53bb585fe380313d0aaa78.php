<div class="bg-white-200 py-4 px-0 mb-20 items-center justify-between tab-text " id="tab2Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="lg:w-1/2 mt-2 lg:mt-0 order-1 flex w-full">
            ...
            <img src="<?php echo e(asset('images/banners/child_one.jpg')); ?>" alt="Banner Image"
                class="imagechild w-full object-cover aspect-w-1 aspect-h-1">
        </div>
    </div>
</div>
...
<?php /**PATH /home/codeartisan/Desktop/laravelapps/dummy3/dummy2/resources/views/components/childtab.blade.php ENDPATH**/ ?>