<div class="bg-white-200 py-4 px-0 mb-20 items-center justify-between tab-text " id="tab2Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        ...
        <div class="lg:w-1/2 mt-10 lg:mt-0 order-1 lg:order-2 ">
            ...
            <img src="<?php echo e(asset('images/banners/child_one.jpg')); ?>" alt="Banner Image" class=" imagechild lg:h-1/2 w-full lg:w-full  object-contain">
        </div>
    </div>
</div>
...
<style>
.imagechild {
    max-height: 60vh; /* Adjusts the maximum height of the image */
    

}
</style>
<?php /**PATH D:\Projects\Bethel Donations\dummy\dummy2\resources\views/components/childtab.blade.php ENDPATH**/ ?>