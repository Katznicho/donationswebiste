<div class="bg-white-200 py-4 px-0 mb-20 items-center justify-between tab-text" id="tab1Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        <div class="lg:w-1/2 lg:mr-4 order-2 lg:order-1 mt-10 lg:mt-0">
            ...
            <!-- Sponsor Button -->
             <div class="mt-10">
                          <a class="bg-blue-900 text-white px-4 py-2 rounded-md my-5 " href="<?php echo e(route('babies.index')); ?>">Sponsor</a>
             </div>
...
<?php /**PATH D:\Projects\Bethel Donations\dummy\dummy_new_23rd\resources\views/components/babytab.blade.php ENDPATH**/ ?>