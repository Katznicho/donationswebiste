                            ...
                            <div class="w-70 h-30 flex flex-col bg-white rounded-lg shadow-md py-2 px-2">
                                ...
                                <div id="myModal" class="modal " style="display:none;">
                                    <div class="modal-content py-10 px-10">
                                        <span class="close-button ml-5" onclick="Close()">&times;</span>
                                        <div class="upper-section border border-blue-300 ">
...
<script>
    $(document).ready(function() {
        ...
        <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            console.log('dob');
            console.log(dob);
            showShortenedStory(hobby, '<?php echo e($child->first_name); ?> <?php echo e($child->second_name); ?>', '<?php echo e($child->id); ?>', story, dob);
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    });
...
</script><?php /**PATH D:\Projects\Bethel Donations\dummy\dummy2\resources\views/child/load.blade.php ENDPATH**/ ?>