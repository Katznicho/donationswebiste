...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-10">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a href="{{ route('register') }}" class="underline text-sm text-gray-600 hover:text-gray-900 ms-1 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                {{ __('Register') }}
            </a>
        </div>
