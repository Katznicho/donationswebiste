<div class="bg-white-200 py-0 lg:py-4 px-0 mb-10 items-center justify-between tab-text" id="tab1Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        <div class="lg:w-1/2 lg:mr-4 order-2 lg:order-1 mt-10 lg:mt-0">
            ...
            <h1 class="title text-7xl font-bold text-black mb-4">Restore Hope.</h1>
            <p class="text-lg text-gray-600 mt-1 mb-10">
               We provide orphaned and abandoned children with a loving Christian home where they receive all the love, care, protection and practical support they need to thrive.
            </p>
            <p class="text-lg text-gray-600 mt-10">
              With $33, we are able to rescue a child from wherever they are abandoned, feed them, provide shelter and for some in extreme health conditions, place them under intense medical program.</p>
            <!-- Sponsor Button -->
             <div class="mt-10">
