    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="text-white mr-20 justify-start">
            ...
            <div class="flex">
              ...
              <i class="facebook" style="font-size: 2px;">
                    <img src="{{ asset('images/facebook.png') }}" alt="logo"  class="mr-2">
                </i>
                <i class="twitter">
                    <img src="{{ asset('images/twitter (1).png') }}" alt="logo"  class="mr-2">
                </i>
                <i class="youtube">
                    <img src="{{ asset('images/youtube.png') }}" alt="logo"  height="100px" style="height: 40px;" class="mt-0 mr-2">
                </i>
                <i class="instagram">
        ...
        <div class="text-white ">
            ...
            <div class="grid grid-rows-2 gap-2 ">
                <button class=" hover:bg-blue-600 text-white w-40 px-2 py-2 rounded-full" style="background-color: #E31F62;">Donate Now</button>
                <button class=" hover:bg-red-600 text-white px-2 w-60 py-2 rounded-full"  style="background-color: #12B0D1;">Subscribe to our Newletter</button>
            </div>
            <br>
            <br>
            {{-- add copy right --}}
